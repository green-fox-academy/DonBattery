...
post3 = BlogPost('John Doe', 'One Engineer Is Trying to Get IBM to Reckon With Trump', 'Daniel Hanley', '2017.03.28.')

print(post3.title, post3.author_name, post3.text, post3.publication_date)
